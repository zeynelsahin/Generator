...
namespace Generator.DataAccess.EntityFramework
{
    public class GeneratorContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ServiceMethod>().Property(s => s.GetValidMethodFlag).HasColumnName("GET_VALID_METHOD_FLAG");
            modelBuilder.Entity<ServiceMethod>().Property(s => s.GetPagedMethodFlag).HasColumnName("GET_PAGED_METHOD_FLAG");
            modelBuilder.Entity<ServiceMethod>().Property(s => s.GetPrimaryKeyMethodFlag).HasColumnName("GET_PRIMARY_KEY_METHOD_FLAG");
